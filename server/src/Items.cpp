...
const int WEAPON_TYPE_SWORD = 1;
const int WEAPON_TYPE_PISTOL = 2;
const int WEAPON_TYPE_SHATTERGUN = 3;
const int WEAPON_TYPE_RIFLE = 4;
const int WEAPON_TYPE_ROCKET = 5;
const int WEAPON_TYPE_GRENADE = 6;
...
void Items::setItemStats(Player* plr) {
    ...
    for (int i = 0; i < 4; i++) {
        ...
        switch (itemStatsDat->weaponType) {
            case WEAPON_TYPE_SWORD:
                plr->pointDamage += itemStatsDat->pointDamage * 1.75;
                plr->groupDamage += itemStatsDat->groupDamage * 1.75;
                break;
            default:
